    ...
    extends tao_actions_form_Instance
{
    protected function initForm()
    {
        ...
        $saveELt->setValue('<button class="form-submitter small li-inner waves-effect waves-light btn btn_small" type="button"><span class="icon-save"></span>'.__('Save').'</button>');
